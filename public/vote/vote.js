...
// 2026년 송도마스터즈 연간 일정 — 정기 라운딩은 매월 첫째 수요일(6월은 둘째 수요일), 8월은 알펜시아 700 GC 1박2일
const ANNUAL_SCHEDULE_2026 = [
    ...
    { month: 8,  dateStr: '2026-08-07', day: '금', label: '정라(1박2일) 1일차', course: '알펜시아 700 GC' },
    { month: 8,  dateStr: '2026-08-08', day: '토', label: '정라(1박2일) 2일차', course: '알펜시아 700 GC' },
...
function renderAnnualSchedule(container) {
    ...
    items.forEach(item => {
        ...
        const isNext = nextTime && item.date.getTime() === nextTime;
